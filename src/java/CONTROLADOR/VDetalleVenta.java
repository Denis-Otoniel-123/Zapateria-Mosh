 ...
 */
public class VDetalleVenta extends HttpServlet {
int id;
    String listar="Vdetalle_venta.jsp";
     String venta="Vventas.jsp";
     String ticket="Vticketventa.jsp";
    ventaDAO pDAO;
    venta v=new venta();
 ...
 DecimalFormat formateador ;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet VDetalleVenta</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet VDetalleVenta at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
