...
public class ControllerPdf extends HttpServlet {
    ...
    public static final String lIST_STUDENT = "/ArchivosPDF.jsp";
    public static final String INSERT_OR_EDIT = "/ArchivosPDF.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher view = request.getRequestDispatcher("/ArchivosPDF.jsp");
        view.forward(request, response);
    }
