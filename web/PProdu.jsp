						...
						<tr>
							...
							<td>
                                                         ...
                                                         if(Estado.equalsIgnoreCase("Activo")){ %>
                                                            ...
                                                            <a href="Producontrolador?accion=estado&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Anular"/></a>
							   
                                                          <%   }else{ %>
                                                           
                                                        <%     }
                                                        %>
                                                          <a href="Producontrolador?accion=editar&id=<%= pro.getId()%> " type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalEditProduccion" ><img src="Imagen/editar.png" title="Modificar"/></a>
