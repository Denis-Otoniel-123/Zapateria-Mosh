                                                ...
                                                <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
                                                 ...
                                                 <div class="mdl-textfield mdl-js-textfield">
                                                     ...
                                                     <select  name="txtidproducto" class="form-control" required="">
                                                         <option  value="" selected="" disabled="">Seleciona Producto</option>
                                                            <%
						...
						<tr>
							...
							<td>
                                                         ...
                                                         if(Estado.equalsIgnoreCase("Activo")){ %>
                                                            ...
                                                            <a href="AProduccionController?accion=estado&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Anular"/></a>
							   
                                                          <%   }else{ %>
                                                           
                                                        <%     }
                                                        %>
                                                          <a href="AProduccionController?accion=editar&id=<%= pro.getId()%> " type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalEditProduccion" ><img src="Imagen/editar.png" title="Modificar"/></a>
