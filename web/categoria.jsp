				...
				<div class="mdl-grid">
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
						...
						<tr>
                                                    <td><%= per.getCodigo()%> </td>
                                                    <td><%= per.getNombre()%></td>
                                                     <% String Estado=categoriaDAO.estado(per.getCodigo());
                                                        ...
                                                        %> 
                                                    <td>
                                                       <a href="Categoriacontroller?accion=editar&id=<%= per.getCodigo()%> " type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalEdit" ><img src="Imagen/editar.png" title="Modificar"/></a>
                                                       <a href="Categoriacontroller?accion=estado&id=<%= per.getCodigo()%>"  class="btn btn-danger" ><img src="Imagen/delete.png" title="Eliminar"/></a>  
                                                    </td>
						</tr>
