					...
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
						<div class="full-width panel mdl-shadow--2dp">
							...
							<div class="full-width panel-content">
                                                              <form action="APedidoprimacontroller">
                                        <div class="mdl-grid">
                                                <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
                                                 ...
                                                 <div class="mdl-textfield mdl-js-textfield">
                                                     ...
                                                     <select  name="txtidprima" class="form-control" required="">
                                                         <option  disabled=""value=""selected="">Seleciona Materia prima</option>
                                                            <%
                                            ...
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                <input name="txtcantidad" class="mdl-textfield__input" type="number>0" pattern="-?[1-9]*(\.[1-9]+)?" id="txtcantidad" required>
                                                    ...
                                                    <td><%= PrimaDAO.getPrima(pro.getIdprima())%></td>
                                                        ...
                                                        <td>
                                                         ...
                                                         if(Estado.equalsIgnoreCase("Activo")){ %>
                                                            ...
                                                            <a href="APedidoprimacontroller?accion=estado&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Eliminar"/></a>
                                                        ...
                                                        %>
                                                           ...
                                                           <a href="APedidoprimacontroller?accion=editar&id=<%= pro.getId()%> " type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalEditpedidoprima" ><img src="Imagen/editar.png" title="Modificar"/></a>
