				...
				<div class="mdl-grid">
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
											...
											<label class="mdl-textfield__label"></label>
                                                    ...
                                                    <thead>
                                                       ...
                                                       <%
                                                        ...
                                                        List<diseño>list=dao.Listado();
                                                        Iterator<diseño>iter=list.iterator();
                                                        diseño per=null;
                                                        while (iter.hasNext()) {
                                                                per = iter.next();
						...
						<tr>
                                                    <td><%= per.getId()%> </td>
                                                    <td><%= per.getNombre()%></td>
                                                     <% String Estado=diseñoDAO.estado(per.getId());
                                                        ...
                                                        %> 
                                                    <td>
                                                       <a href="DiseControlador?accion=editar&id=<%= per.getId()%> " type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalEdit" ><img src="Imagen/editar.png" title="Modificar"/></a>
                                                       <a href="DiseControlador?accion=estado&id=<%= per.getId()%>"  class="btn btn-danger" ><img src="Imagen/delete.png" title="Eliminar"/></a>  
                                                    </td>
						</tr>
