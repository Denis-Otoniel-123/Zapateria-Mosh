					...
					<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
						<div class="full-width panel mdl-shadow--2dp">
							...
							<div class="full-width panel-content">
                                                             <form action="AProveedorControlador">
									...
									<div  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										...
										<span class="mdl-textfield__error">Invalido E-mail</span>
                                                                        ...
                                                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                                            <input name="txtcontacto" class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" required="">
										<label class="mdl-textfield__label" for="phoneClient">Contacto</label>
										<span class="mdl-textfield__error">Invalido numero de Contacto</span>
									</div>
									<div  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
					...
					<tbody>
						...
						<tr>
							 ...
							 <td><%= clienteDAO.getDNI(per.getId())%></td>
                                                         ...
                                                         <td><%= per.getContato()%></td>
                                                        <td><%= per.getTelefono_contacto()%></td>
                                                        <td><%= clienteDAO.getemail(per.getId())%></td>
							<td>
                                                            <a href="AProveedorControlador?accion=eliminar&id=<%= per.getId()%> " type="button" class="btn btn-danger"  ><img src="Imagen/delete.png" title="Modificar"/>      
                                                       
							 <a href="AProveedorControlador?accion=editar&id=<%= per.getId()%> " type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalEditCliente" ><img src="Imagen/editar.png" title="Modificar"/>      
