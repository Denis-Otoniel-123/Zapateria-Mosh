                                               ...
                                               <select name="txttipocomprbante" class="mdl-textfield__input" required>
                                                   <option value="" disabled="" selected="">Seleciona Tipo de Com.</option>
                                                           ...
                                                           <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                                   ...
                                                                   <label class="mdl-textfield__label" for="NameProduct">Ruc</label>
                                                                   <span class="mdl-textfield__error">Invalido Ruc</span>
                                                           </div>
						...
						<tr>
							...
							<td>
                                                         ...
                                                         if(Estado.equalsIgnoreCase("Vendido")){ %>
                                                            ...
                                                            <a href="VDetalleVenta?accion=estado&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Anular"/></a>
							   
                                                          <%   }else{ %>
                                                           
                                                        <%     }
                                                        %>
                                                             <a href="VDetalleVenta?accion=reporte&id=<%= pro.getId()%>" class="btn btn-success" ><img src="Imagen/lpdf.png" title="Reporte"/></a>
