					...
					<tbody>
						...
						<tr>
							...
							<td>
							 ...
							 <a href="Clientecontroller?accion=editar&id=<%= per.getId()%> " type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalEditCliente" ><img src="Imagen/editar.png" title="Modificar"/>      
                                                        <a href="Clientecontroller?accion=eliminar&id=<%= per.getId()%>" class="btn btn-danger" style="margin: 10px" ><img src="Imagen/delete.png" title="Eliminar"/></a>  
