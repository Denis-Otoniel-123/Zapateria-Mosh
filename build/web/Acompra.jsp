						...
						<tr>
							...
							<td>
                                                         ...
                                                         if(Estado.equalsIgnoreCase("Comprado")){ %>
                                                            ...
                                                            <a href="ADetalleCCompra?accion=estado&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Anular"/></a>
							   
                                                          <%   }else{ %>
                                                           
                                                        <%     }
                                                        %>
                                                             <a href="ADetalleCCompra?accion=reporte&id=<%= pro.getId()%>" class="btn btn-success" ><img src="Imagen/lpdf.png" title="Reporte"/></a>
