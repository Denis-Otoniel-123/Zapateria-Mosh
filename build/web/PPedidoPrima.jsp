                                                    ...
                                                    <td><%= PrimaDAO.getPrima(pro.getIdprima())%></td>
                                                        ...
                                                        <td>
                                                         ...
                                                         if(Estado.equalsIgnoreCase("Activo")){ %>
                                                            ...
                                                            <a href="PPedidocontroller?accion=estado&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Eliminar"/></a>
                                                        ...
                                                        %>
                                                           ...
                                                           <a href="PPedidocontroller?accion=editar&id=<%= pro.getId()%> " type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalEditpedidoprima" ><img src="Imagen/editar.png" title="Modificar"/></a>
