						...
						<tr>
                                                    ...
                                                    <td><%= per.getNombre()%></td>
                                                     <% String Estado=marcaDAO.estado(per.getId());
                                                        ...
                                                        %> 
                                                    <td>
                                                       <a href="AMarcaControlador?accion=editar&id=<%= per.getId()%> " type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalEdit" ><img src="Imagen/editar.png" title="Modificar"/></a>
                                                       <a href="AMarcaControlador?accion=estado&id=<%= per.getId()%>"  class="btn btn-danger" ><img src="Imagen/delete.png" title="Eliminar"/></a>  
                                                    </td>
						</tr>
