                                                        ...
                                                        <td>
                                                          <% String estad=pro.getEstado();
                                                            if(estad.equalsIgnoreCase("Activo")){%>
                                                               <a href="DetalleVControlador?accion=anular&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Anular"/></a>
							       <%}else{}    
                                                               %> <a href="DetalleVControlador?accion=eliminar&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Eliminar"/></a>
