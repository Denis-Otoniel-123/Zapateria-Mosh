						...
						<tr>
							...
							<td>Q<%= pro.getPrecio()%></td>
							 ...
							 <% String Estado=pro.getEstado();
                                                        ...
                                                        %>
							<td>
                                                            <a href="Primacontroller?accion=editar&id=<%= pro.getId()%> " type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalEditPrima" ><img src="Imagen/editar.png" title="Modificar"/></a>
                                                         <a href="Primacontroller?accion=estado&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Eliminar"/></a>
							</td>
						</tr>
						<%}%>
