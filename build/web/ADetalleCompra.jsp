                                                        ...
                                                        <td>
                                                          <% String estad=pro.getEstado();
                                                            if(estad.equalsIgnoreCase("Activo")){%>
                                                               <a href="ADetalleCCompra?accion=anular&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Anular"/></a>
							       <%}else{}
                                                               %> <a href="ADetalleCCompra?accion=eliminar&id=<%= pro.getId()%>" class="btn btn-danger" ><img src="Imagen/delete.png" title="Eliminar"/></a>
